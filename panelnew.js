// Modified version of panel.js from JScript Panel 3 by marc2k3
...
// callbacks begin
	this.colours_changed = function () {
		colourSet = GetNowPlayingColours();
		if (window.IsDefaultUI) {
			this.colours.background = colourSet[0];
			this.colours.text = colourSet[1];
			this.colours.highlight = colourSet[2];
		} else {
			this.colours.background = colourSet[0];
			this.colours.text = colourSet[1];
